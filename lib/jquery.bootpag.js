...
(function($, window) {
    ...
    $.fn.bootpag = function(options){
        ...
        function renderPage($bootpag, page){
			...
			var clist = "." + [settings.disabledClass,
            ...
            $currPage.addClass(settings.activeClass);
            $owner.data('settings', settings);
        ...
        return this.each(function(){
            ...
            if(settings.firstLastUse){
                p.push(['<li data-lp="1" class="', settings.firstClass,
                       '"><a href="', href(1), '">', settings.first, '</a></li>']);
            }
            if(settings.prev){
                p.push(['<li data-lp="1" class="', settings.prevClass,
            ...
            me.find('li').click(function paginationClick(){
                ...
                var me = $(this);
                if(me.hasClass(settings.activeClass) || me.hasClass(settings.disabledClass)){
                    return;
                }
